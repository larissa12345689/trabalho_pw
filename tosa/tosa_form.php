...
<body class="corpo-tosa">
 
    <div class="pagina-tosa">
        <div class="caixa-tosa">
 
            <div class="tosa-icone">✂️</div>
            <h2 class="tosa-titulo">Agendar Tosa</h2>
            <p class="tosa-subtitulo">Preencha os dados do seu pet para agendar</p>
 
            <form action="processa_tosa.php" method="POST" class="tosa-formulario">
                <div class="tosa-grade">
                    ...
                    <div class="campo-grupo">
                        ...
                        <input type="text" name="raca" placeholder="Ex: Poodle" class="campo-input" required>
                    </div>
 
                    <div class="campo-grupo">
                        <label class="campo-label">Porte</label>
                        <input type="text" name="porte" placeholder="Ex: Pequeno" class="campo-input" required>
                    </div>
                    ...
                    <div class="campo-grupo">
                        ...
                        <input type="text" name="idade" placeholder="Ex: 2 anos" class="campo-input" required>
                    </div>
 
                </div>
 
                <button type="submit" class="btn-tosa">Agendar Tosa ✂️</button>
            </form>
